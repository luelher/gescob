...
abstract class BaseInbox extends BaseObject  implements Persistent {
  ...
  const PEER = 'InboxPeer';
	...
	/**
	 * Initializes internal state of BaseInbox object.
	 * @see        applyDefaults()
	 */
	...
	public function setNumber($v)
	{
		...
		if ($this->number !== $v || $v === '') {
			$this->number = $v;
			$this->modifiedColumns[] = InboxPeer::NUMBER;
		}
	...
	public function setSmsdate($v)
	{
		...
		if ( $this->smsdate !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = InboxPeer::SMSDATE;
			}
	...
	public function setInsertdate($v)
	{
		...
		if ( $this->insertdate !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = InboxPeer::INSERTDATE;
			}
		} // if either are not null
	...
	public function setText($v)
	{
		...
		if ($this->text !== $v) {
			$this->text = $v;
			$this->modifiedColumns[] = InboxPeer::TEXT;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = InboxPeer::PHONE;
		}
	...
	public function setProcessed($v)
	{
		...
		if ($this->processed !== $v || $v === 0) {
			$this->processed = $v;
			$this->modifiedColumns[] = InboxPeer::PROCESSED;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(InboxPeer::NUMBER,InboxPeer::SMSDATE,InboxPeer::PROCESSED))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = InboxPeer::NUM_COLUMNS - InboxPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InboxPeer::NUMBER)) $criteria->add(InboxPeer::NUMBER, $this->number);
		if ($this->isColumnModified(InboxPeer::SMSDATE)) $criteria->add(InboxPeer::SMSDATE, $this->smsdate);
		if ($this->isColumnModified(InboxPeer::INSERTDATE)) $criteria->add(InboxPeer::INSERTDATE, $this->insertdate);
		if ($this->isColumnModified(InboxPeer::TEXT)) $criteria->add(InboxPeer::TEXT, $this->text);
		if ($this->isColumnModified(InboxPeer::PHONE)) $criteria->add(InboxPeer::PHONE, $this->phone);
		if ($this->isColumnModified(InboxPeer::PROCESSED)) $criteria->add(InboxPeer::PROCESSED, $this->processed);
