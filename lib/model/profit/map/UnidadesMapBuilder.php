...
/**
 * This class adds structure of 'unidades' table to 'profit' DatabaseMap object.
 *
 *
 ...
 */
class UnidadesMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.profit.map.UnidadesMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(UnidadesPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(UnidadesPeer::TABLE_NAME);
		$tMap->setPhpName('Unidades');
		$tMap->setClassname('Unidades');

		$tMap->setUseIdGenerator(false);

		$tMap->addPrimaryKey('CO_UNI', 'CoUni', 'CHAR', true, 6);

		$tMap->addColumn('DES_UNI', 'DesUni', 'VARCHAR', true, 60);
