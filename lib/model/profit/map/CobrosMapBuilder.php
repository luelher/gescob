...
class CobrosMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('MONTO', 'Monto', 'FLOAT', true, 20);

		$tMap->addColumn('DPPAGO', 'Dppago', 'FLOAT', true, 20);

		$tMap->addColumn('MONT_NCR', 'MontNcr', 'FLOAT', true, 20);

		$tMap->addColumn('NCR', 'Ncr', 'INTEGER', true, null);

		$tMap->addColumn('TCOMI_PORC', 'TcomiPorc', 'FLOAT', true, 20);

		$tMap->addColumn('TCOMI_LINE', 'TcomiLine', 'FLOAT', true, 20);

		$tMap->addColumn('TCOMI_ART', 'TcomiArt', 'FLOAT', true, 20);

		$tMap->addColumn('TCOMI_CONC', 'TcomiConc', 'FLOAT', true, 20);
