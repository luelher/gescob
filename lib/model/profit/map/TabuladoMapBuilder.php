...
class TabuladoMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('PORC_VENT', 'PorcVent', 'FLOAT', true, 12);

		$tMap->addColumn('PORC_COMP', 'PorcComp', 'FLOAT', true, 12);

		$tMap->addColumn('PORC_CXS', 'PorcCxs', 'FLOAT', true, 12);

		$tMap->addColumn('PORC_OTRO', 'PorcOtro', 'FLOAT', true, 12);
