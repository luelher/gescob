...
/**
 * This class adds structure of 'transpor' table to 'profit' DatabaseMap object.
 *
 *
 ...
 */
class TransporMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.profit.map.TransporMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(TransporPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(TransporPeer::TABLE_NAME);
		$tMap->setPhpName('Transpor');
		$tMap->setClassname('Transpor');

		$tMap->setUseIdGenerator(false);

		$tMap->addPrimaryKey('CO_TRAN', 'CoTran', 'CHAR', true, 6);

		$tMap->addColumn('DES_TRAN', 'DesTran', 'VARCHAR', true, 60);

		$tMap->addColumn('RESP_TRA', 'RespTra', 'VARCHAR', true, 60);
