...
/**
 * This class adds structure of 'moneda' table to 'profit' DatabaseMap object.
 *
 *
...
class MonedaMapBuilder implements MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'lib.model.profit.map.MonedaMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addPrimaryKey('CO_MONE', 'CoMone', 'CHAR', true, 6);

		$tMap->addColumn('MONE_DES', 'MoneDes', 'VARCHAR', true, 60);

		$tMap->addColumn('CAMBIO', 'Cambio', 'FLOAT', true, 20);
