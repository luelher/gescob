...
/**
 * Base class that represents a row from the 'sub_lin' table.
 *
 * 
 *
...
abstract class BaseSubLin extends BaseObject  implements Persistent {
  ...
  const PEER = 'SubLinPeer';
	...
	/**
	 * The value for the subl_des field.
	...
	/**
	 * The value for the i_subl_des field.
	 * Note: this column has a database default value of: ' '
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseSubLin object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [i_subl_des] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     SubLin The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [subl_des] column.
	 * 
	 * @param      string $v new value
	 * @return     SubLin The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [i_subl_des] column.
	 * 
	 * @param      string $v new value
	 * @return     SubLin The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(SubLinPeer::SUBL_DES,SubLinPeer::CAMPO1,SubLinPeer::CAMPO2,SubLinPeer::CAMPO3,SubLinPeer::CAMPO4,SubLinPeer::CO_US_IN,SubLinPeer::CO_US_MO,SubLinPeer::CO_US_EL,SubLinPeer::REVISADO,SubLinPeer::TRASNFE,SubLinPeer::CO_SUCU,SubLinPeer::ROWGUID,SubLinPeer::CO_IMUN,SubLinPeer::CO_RETEN,SubLinPeer::I_SUBL_DES,SubLinPeer::MOVIL))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_subl = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->subl_des = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->co_lin = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			$this->i_subl_des = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			...
			return $startcol + 21; // 21 = SubLinPeer::NUM_COLUMNS - SubLinPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SubLinPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseSubLin:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseSubLin:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseSubLin:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseSubLin:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			SubLinPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SubLin (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SubLin Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this SubLin has previously been saved, it will retrieve
	 * related Arts from storage. If this SubLin is new, it will return
		...
		if ($this->collArts === null) {
			if ($this->isNew()) {
			   $this->collArts = array();
				...
				$criteria->add(ArtPeer::CO_SUBL, $this->co_lin);
	 ...
	 * Otherwise if this SubLin is new, it will return
	 * an empty collection; or if this SubLin has previously
	 * been saved, it will retrieve related Arts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SubLin.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseSubLin:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseSubLin::%s', $method));
    }
