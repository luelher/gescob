  ...
  const PEER = 'DocumCcPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tasa = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->moneda = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->monto_imp = ($row[$startcol + 19] !== null) ? (double) $row[$startcol + 19] : null;
			$this->monto_gen = ($row[$startcol + 20] !== null) ? (double) $row[$startcol + 20] : null;
			$this->monto_a1 = ($row[$startcol + 21] !== null) ? (double) $row[$startcol + 21] : null;
			$this->monto_a2 = ($row[$startcol + 22] !== null) ? (double) $row[$startcol + 22] : null;
			$this->monto_bru = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
			$this->descuentos = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->monto_des = ($row[$startcol + 25] !== null) ? (double) $row[$startcol + 25] : null;
			$this->recargo = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
			$this->monto_rec = ($row[$startcol + 27] !== null) ? (double) $row[$startcol + 27] : null;
			$this->monto_otr = ($row[$startcol + 28] !== null) ? (double) $row[$startcol + 28] : null;
			$this->monto_net = ($row[$startcol + 29] !== null) ? (double) $row[$startcol + 29] : null;
			$this->saldo = ($row[$startcol + 30] !== null) ? (double) $row[$startcol + 30] : null;
			...
			$this->comis1 = ($row[$startcol + 34] !== null) ? (double) $row[$startcol + 34] : null;
			$this->comis2 = ($row[$startcol + 35] !== null) ? (double) $row[$startcol + 35] : null;
			$this->comis3 = ($row[$startcol + 36] !== null) ? (double) $row[$startcol + 36] : null;
			$this->comis4 = ($row[$startcol + 37] !== null) ? (double) $row[$startcol + 37] : null;
			$this->adicional = ($row[$startcol + 38] !== null) ? (double) $row[$startcol + 38] : null;
			...
			$this->mon_ilc = ($row[$startcol + 58] !== null) ? (double) $row[$startcol + 58] : null;
			$this->otros1 = ($row[$startcol + 59] !== null) ? (double) $row[$startcol + 59] : null;
			$this->otros2 = ($row[$startcol + 60] !== null) ? (double) $row[$startcol + 60] : null;
			$this->otros3 = ($row[$startcol + 61] !== null) ? (double) $row[$startcol + 61] : null;
			$this->reng_si = ($row[$startcol + 62] !== null) ? (boolean) $row[$startcol + 62] : null;
			$this->comis5 = ($row[$startcol + 63] !== null) ? (double) $row[$startcol + 63] : null;
			$this->comis6 = ($row[$startcol + 64] !== null) ? (double) $row[$startcol + 64] : null;
			$this->row_id = ($row[$startcol + 65] !== null) ? (string) $row[$startcol + 65] : null;
			$this->aux01 = ($row[$startcol + 66] !== null) ? (double) $row[$startcol + 66] : null;
