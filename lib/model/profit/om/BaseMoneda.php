...
abstract class BaseMoneda extends BaseObject  implements Persistent {
  ...
  const PEER = 'MonedaPeer';
	...
	/**
	 * The value for the co_mone field.
	 * @var        string
	 */
	protected $co_mone;

	/**
	 * The value for the mone_des field.
	...
	/**
	 * The value for the cambio field.
	...
	/**
	 * Set the value of [co_mone] column.
	 * 
	...
	/**
	 * Set the value of [mone_des] column.
	 * 
	 * @param      string $v new value
	 * @return     Moneda The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [cambio] column.
	 * 
	 * @param      string $v new value
	 * @return     Moneda The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(MonedaPeer::MONE_DES,MonedaPeer::CAMBIO,MonedaPeer::CAMPO1,MonedaPeer::CAMPO2,MonedaPeer::CAMPO3,MonedaPeer::CAMPO4,MonedaPeer::CO_US_IN,MonedaPeer::CO_US_MO,MonedaPeer::CO_US_EL,MonedaPeer::REVISADO,MonedaPeer::TRASNFE,MonedaPeer::CO_SUCU,MonedaPeer::ROWGUID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_mone = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->mone_des = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->cambio = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 17; // 17 = MonedaPeer::NUM_COLUMNS - MonedaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Generic method to set the primary key (co_mone column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCoMone($this->co_mone);
	 ...
	 * related DocumCcs from storage. If this Moneda is new, it will return
		...
		if ($this->collDocumCcs === null) {
			if ($this->isNew()) {
			   $this->collDocumCcs = array();
				...
				$criteria->add(DocumCcPeer::MONEDA, $this->co_mone);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Moneda has previously been saved, it will retrieve
	 * related Cobross from storage. If this Moneda is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCobross === null) {
			if ($this->isNew()) {
			   $this->collCobross = array();
				...
				$criteria->add(CobrosPeer::MONEDA, $this->co_mone);
