...
/**
 * Base class that represents a row from the 'colores' table.
 *
 * 
 *
...
abstract class BaseColores extends BaseObject  implements Persistent {
  ...
  const PEER = 'ColoresPeer';
	...
	/**
	 * The value for the co_col field.
	 * @var        string
	 */
	protected $co_col;

	/**
	 * The value for the des_col field.
	...
	/**
	 * Initializes internal state of BaseColores object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Set the value of [co_col] column.
	 * 
	 * @param      string $v new value
	 * @return     Colores The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [des_col] column.
	 * 
	 * @param      string $v new value
	 * @return     Colores The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ColoresPeer::DES_COL,ColoresPeer::CAMPO1,ColoresPeer::CAMPO2,ColoresPeer::CAMPO3,ColoresPeer::CAMPO4,ColoresPeer::CO_US_IN,ColoresPeer::CO_US_MO,ColoresPeer::CO_US_EL,ColoresPeer::REVISADO,ColoresPeer::TRASNFE,ColoresPeer::CO_SUCU,ColoresPeer::ROWGUID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_col = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->des_col = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 16; // 16 = ColoresPeer::NUM_COLUMNS - ColoresPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ColoresPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseColores:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseColores:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseColores:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseColores:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ColoresPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	/**
	 * Generic method to set the primary key (co_col column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Colores (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Colores Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Colores has previously been saved, it will retrieve
	 * related Arts from storage. If this Colores is new, it will return
		...
		if ($this->collArts === null) {
			if ($this->isNew()) {
			   $this->collArts = array();
				...
				$criteria->add(ArtPeer::CO_COLOR, $this->co_col);
	 ...
	 * Otherwise if this Colores is new, it will return
	 * an empty collection; or if this Colores has previously
	 * been saved, it will retrieve related Arts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Colores.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseColores:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseColores::%s', $method));
    }
