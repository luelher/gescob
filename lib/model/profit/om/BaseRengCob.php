...
abstract class BaseRengCob extends BaseObject  implements Persistent {
  ...
  const PEER = 'RengCobPeer';
	...
	/**
	 * @var        Cobros one-to-one related Cobros object
	 */
	protected $singleCobros;
	...
	public function setDocNum($v)
	{
		...
		if ($this->aDocumCc !== null && $this->aDocumCc->getNroDoc() !== $v) {
			$this->aDocumCc = null;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->neto = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
			$this->neto_tmp = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
			$this->dppago = ($row[$startcol + 6] !== null) ? (double) $row[$startcol + 6] : null;
			...
			$this->comis1 = ($row[$startcol + 10] !== null) ? (double) $row[$startcol + 10] : null;
			$this->comis2 = ($row[$startcol + 11] !== null) ? (double) $row[$startcol + 11] : null;
			$this->comis3 = ($row[$startcol + 12] !== null) ? (double) $row[$startcol + 12] : null;
			$this->comis4 = ($row[$startcol + 13] !== null) ? (double) $row[$startcol + 13] : null;
			$this->sign_aju_c = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->porc_aju_c = ($row[$startcol + 15] !== null) ? (double) $row[$startcol + 15] : null;
			$this->por_cob = ($row[$startcol + 16] !== null) ? (double) $row[$startcol + 16] : null;
			$this->comi_cob = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->mont_cob = ($row[$startcol + 18] !== null) ? (double) $row[$startcol + 18] : null;
			...
			$this->monto_dppago = ($row[$startcol + 21] !== null) ? (double) $row[$startcol + 21] : null;
			$this->monto_reten = ($row[$startcol + 22] !== null) ? (double) $row[$startcol + 22] : null;
			$this->imp_pago = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
			$this->monto_obj = ($row[$startcol + 24] !== null) ? (double) $row[$startcol + 24] : null;
			$this->isv = ($row[$startcol + 25] !== null) ? (double) $row[$startcol + 25] : null;
			...
			$this->tasa = ($row[$startcol + 28] !== null) ? (double) $row[$startcol + 28] : null;
			$this->numcon = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
			$this->sustraen = ($row[$startcol + 30] !== null) ? (double) $row[$startcol + 30] : null;
			...
			$this->comis5 = ($row[$startcol + 35] !== null) ? (double) $row[$startcol + 35] : null;
			$this->comis6 = ($row[$startcol + 36] !== null) ? (double) $row[$startcol + 36] : null;
			$this->fact_iva = ($row[$startcol + 37] !== null) ? (int) $row[$startcol + 37] : null;
			$this->ret_iva = ($row[$startcol + 38] !== null) ? (double) $row[$startcol + 38] : null;
			$this->porc_retn = ($row[$startcol + 39] !== null) ? (double) $row[$startcol + 39] : null;
			$this->porc_desc = ($row[$startcol + 40] !== null) ? (double) $row[$startcol + 40] : null;
			$this->aux01 = ($row[$startcol + 41] !== null) ? (double) $row[$startcol + 41] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aDocumCc !== null && $this->doc_num !== $this->aDocumCc->getNroDoc()) {
			$this->aDocumCc = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aDocumCc !== null) {
				if ($this->aDocumCc->isModified() || $this->aDocumCc->isNew()) {
					$affectedRows += $this->aDocumCc->save($con);
				}
				$this->setDocumCc($this->aDocumCc);
			}
			...
			if ($this->singleCobros !== null) {
				if (!$this->singleCobros->isDeleted()) {
						$affectedRows += $this->singleCobros->save($con);
				}
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aDocumCc !== null) {
				if (!$this->aDocumCc->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aDocumCc->getValidationFailures());
				}
			}
			...
			if (($retval = RengCobPeer::doValidate($this, $columns)) !== true) {
				...
				if ($this->singleCobros !== null) {
					if (!$this->singleCobros->validate($columns)) {
						$failureMap = array_merge($failureMap, $this->singleCobros->getValidationFailures());
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			$relObj = $this->getCobros();
			if ($relObj) {
				$copyObj->setCobros($relObj->copy($deepCopy));
			}
	...
	/**
	 * Declares an association between this object and a DocumCc object.
	 *
	 * @param      DocumCc $v
	 * @return     RengCob The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setDocumCc(DocumCc $v = null)
	{
		if ($v === null) {
			$this->setDocNum(0);
		} else {
			$this->setDocNum($v->getNroDoc());
		}

		$this->aDocumCc = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the DocumCc object, it will not be re-added.
		if ($v !== null) {
			$v->addRengCob($this);
		}
	...
	/**
	 * Get the associated DocumCc object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     DocumCc The associated DocumCc object.
	 * @throws     PropelException
	 */
	public function getDocumCc(PropelPDO $con = null)
	{
		if ($this->aDocumCc === null && ($this->doc_num !== null)) {
			$c = new Criteria(DocumCcPeer::DATABASE_NAME);
			$c->add(DocumCcPeer::NRO_DOC, $this->doc_num);
			$this->aDocumCc = DocumCcPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aDocumCc->addRengCobs($this);
			 */
		}
		return $this->aDocumCc;
	}

	/**
	 * Gets a single Cobros object, which is related to this object by a one-to-one relationship.
	 *
	 * @param      PropelPDO $con
	 * @return     Cobros
	 * @throws     PropelException
	 */
	public function getCobros(PropelPDO $con = null)
	{

		if ($this->singleCobros === null && !$this->isNew()) {
			$this->singleCobros = CobrosPeer::retrieveByPK($this->cob_num, $con);
		}

		return $this->singleCobros;
	}

	/**
	 * Sets a single Cobros object as related to this object by a one-to-one relationship.
	 *
	 * @param      Cobros $l Cobros
	 * @return     RengCob The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setCobros(Cobros $v)
	{
		$this->singleCobros = $v;

		// Make sure that that the passed-in Cobros isn't already associated with this object
		if ($v->getRengCob() === null) {
			$v->setRengCob($this);
		}
	...
	{
		if ($deep) {
			if ($this->singleCobros) {
				$this->singleCobros->clearAllReferences($deep);
			}
		} // if ($deep)
