...
/**
 * Base class that represents a row from the 'cta_ingr' table.
 *
 * 
 *
...
abstract class BaseCtaIngr extends BaseObject  implements Persistent {
  ...
  const PEER = 'CtaIngrPeer';
	...
	/**
	 * Initializes internal state of BaseCtaIngr object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CtaIngr The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CtaIngrPeer::DESCRIP,CtaIngrPeer::CTA_CONTAB,CtaIngrPeer::DIS_CEN,CtaIngrPeer::CAMPO1,CtaIngrPeer::CAMPO2,CtaIngrPeer::CAMPO3,CtaIngrPeer::CAMPO4,CtaIngrPeer::CO_US_IN,CtaIngrPeer::CO_US_MO,CtaIngrPeer::CO_US_EL,CtaIngrPeer::REVISADO,CtaIngrPeer::TRASNFE,CtaIngrPeer::CO_SUCU,CtaIngrPeer::ROWGUID,CtaIngrPeer::CO_ISLR))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_ingr = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->descrip = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->cta_contab = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			$this->co_islr = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->resetModified();
			...
			return $startcol + 19; // 19 = CtaIngrPeer::NUM_COLUMNS - CtaIngrPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CtaIngrPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCtaIngr:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCtaIngr:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCtaIngr:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCtaIngr:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CtaIngrPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	/**
	 * Generic method to set the primary key (co_ingr column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CtaIngr (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CtaIngr Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this CtaIngr has previously been saved, it will retrieve
	 * related Clientess from storage. If this CtaIngr is new, it will return
		...
		if ($this->collClientess === null) {
			if ($this->isNew()) {
			   $this->collClientess = array();
				...
				$criteria->add(ClientesPeer::CO_INGR, $this->co_ingr);
	 ...
	 * Otherwise if this CtaIngr is new, it will return
	 * an empty collection; or if this CtaIngr has previously
	 * been saved, it will retrieve related Clientess from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CtaIngr.
	 */
	 ...
	 * actually need in CtaIngr.
	 */
	public function getClientessJoinVendedor($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CtaIngrPeer::DATABASE_NAME);
		}
		...
		if ($this->collClientess === null) {
			if ($this->isNew()) {
				...
				$this->collClientess = ClientesPeer::doSelectJoinVendedor($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CtaIngr has previously been saved, it will retrieve
	 * related Provs from storage. If this CtaIngr is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProvs === null) {
			if ($this->isNew()) {
			   $this->collProvs = array();
				...
				$criteria->add(ProvPeer::CO_INGR, $this->co_ingr);
	 ...
	 * actually need in CtaIngr.
	 */
	public function getProvsJoinTipoPro($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CtaIngrPeer::DATABASE_NAME);
		}
		...
		if ($this->collProvs === null) {
			if ($this->isNew()) {
				...
				$this->collProvs = ProvPeer::doSelectJoinTipoPro($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCtaIngr:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCtaIngr::%s', $method));
    }
