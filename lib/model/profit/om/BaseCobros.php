...
abstract class BaseCobros extends BaseObject  implements Persistent {
  ...
  const PEER = 'CobrosPeer';
	...
	/**
	 * Get the [optionally formatted] temporal [fec_cob] column value.
	 * 
	 *
	...
	{
		if ($this->fec_cob === null) {
			return null;
		}


		if ($this->fec_cob === '0000-00-00') {
			// while technically this is not a default value of NULL,
			// this seems to be closest in meaning.
			return null;
		} else {
			try {
				$dt = new MssqlDateTime($this->fec_cob);
			} catch (Exception $x) {
				throw new PropelException("Internally stored date/time/timestamp value could not be converted to MssqlDateTime: " . var_export($this->fec_cob, true), $x);
			}
		}
	...
	public function setCobNum($v)
	{
		...
		if ($this->aRengCob !== null && $this->aRengCob->getCobNum() !== $v) {
			$this->aRengCob = null;
		}
	...
	/**
	 * Sets the value of [fec_cob] column to a normalized version of the date/time value specified.
	 * 
	...
	public function setFecCob($v)
	{
		...
		if ( $this->fec_cob !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->fec_cob !== null && $tmpDt = new MssqlDateTime($this->fec_cob)) ? $tmpDt->format('Y-m-d') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->fec_cob = ($dt ? $dt->format('Y-m-d') : null);
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->dppago = ($row[$startcol + 7] !== null) ? (double) $row[$startcol + 7] : null;
			$this->mont_ncr = ($row[$startcol + 8] !== null) ? (double) $row[$startcol + 8] : null;
			$this->ncr = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->tcomi_porc = ($row[$startcol + 10] !== null) ? (double) $row[$startcol + 10] : null;
			$this->tcomi_line = ($row[$startcol + 11] !== null) ? (double) $row[$startcol + 11] : null;
			$this->tcomi_art = ($row[$startcol + 12] !== null) ? (double) $row[$startcol + 12] : null;
			$this->tcomi_conc = ($row[$startcol + 13] !== null) ? (double) $row[$startcol + 13] : null;
			$this->feccom = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->tasa = ($row[$startcol + 15] !== null) ? (double) $row[$startcol + 15] : null;
			...
			$this->aux01 = ($row[$startcol + 43] !== null) ? (double) $row[$startcol + 43] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aRengCob !== null && $this->cob_num !== $this->aRengCob->getCobNum()) {
			$this->aRengCob = null;
		}
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aRengCob !== null) {
				if ($this->aRengCob->isModified() || $this->aRengCob->isNew()) {
					$affectedRows += $this->aRengCob->save($con);
				}
				$this->setRengCob($this->aRengCob);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aRengCob !== null) {
				if (!$this->aRengCob->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aRengCob->getValidationFailures());
				}
			}
	...
	/**
	 * Declares an association between this object and a RengCob object.
	 *
	 * @param      RengCob $v
	 * @return     Cobros The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setRengCob(RengCob $v = null)
	{
		if ($v === null) {
			$this->setCobNum(NULL);
		} else {
			$this->setCobNum($v->getCobNum());
		}
	...
	/**
	 * Get the associated RengCob object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     RengCob The associated RengCob object.
	 * @throws     PropelException
	 */
	public function getRengCob(PropelPDO $con = null)
	{
		if ($this->aRengCob === null && ($this->cob_num !== null)) {
			$c = new Criteria(RengCobPeer::DATABASE_NAME);
			$c->add(RengCobPeer::COB_NUM, $this->cob_num);
			$this->aRengCob = RengCobPeer::doSelectOne($c, $con);
			// Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
			$this->aRengCob->setCobros($this);
		}
		return $this->aRengCob;
	}
