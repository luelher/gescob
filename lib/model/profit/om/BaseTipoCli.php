...
/**
 * Base class that represents a row from the 'tipo_cli' table.
 *
 * 
 *
...
abstract class BaseTipoCli extends BaseObject  implements Persistent {
  ...
  const PEER = 'TipoCliPeer';
	...
	/**
	 * The value for the tip_cli field.
	 * @var        string
	 */
	protected $tip_cli;
	...
	/**
	 * The value for the precio_a field.
	 * Note: this column has a database default value of: ' '
	 * @var        string
	 */
	protected $precio_a;
	...
	/**
	 * Initializes internal state of BaseTipoCli object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Set the value of [tip_cli] column.
	 * 
	 * @param      string $v new value
	 * @return     TipoCli The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [precio_a] column.
	 * 
	 * @param      string $v new value
	 * @return     TipoCli The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(TipoCliPeer::DES_TIPO,TipoCliPeer::PRECIO_A,TipoCliPeer::CAMPO1,TipoCliPeer::CAMPO2,TipoCliPeer::CAMPO3,TipoCliPeer::CAMPO4,TipoCliPeer::CO_US_IN,TipoCliPeer::CO_US_MO,TipoCliPeer::CO_US_EL,TipoCliPeer::REVISADO,TipoCliPeer::TRASNFE,TipoCliPeer::CO_SUCU,TipoCliPeer::ROWGUID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tip_cli = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->des_tipo = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->precio_a = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			$this->row_id = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->resetModified();
			...
			return $startcol + 18; // 18 = TipoCliPeer::NUM_COLUMNS - TipoCliPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipoCliPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseTipoCli:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTipoCli:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTipoCli:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTipoCli:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			TipoCliPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	/**
	 * Generic method to set the primary key (tip_cli column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TipoCli (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTipCli($this->tip_cli);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TipoCli Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this TipoCli has previously been saved, it will retrieve
	 * related Clientess from storage. If this TipoCli is new, it will return
		...
		if ($this->collClientess === null) {
			if ($this->isNew()) {
			   $this->collClientess = array();
				...
				$criteria->add(ClientesPeer::TIPO, $this->tip_cli);
	 ...
	 * Otherwise if this TipoCli is new, it will return
	 * an empty collection; or if this TipoCli has previously
	 * been saved, it will retrieve related Clientess from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TipoCli.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTipoCli:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTipoCli::%s', $method));
    }
