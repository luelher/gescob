...
abstract class BaseSegmento extends BaseObject  implements Persistent {
  ...
  const PEER = 'SegmentoPeer';
	...
	/**
	 * The value for the seg_des field.
	...
	/**
	 * The value for the c_cuenta field.
	 * Note: this column has a database default value of: ' '
	 * @var        string
	 */
	protected $c_cuenta;
	...
	/**
	 * The value for the p_cuenta field.
	 * Note: this column has a database default value of: ' '
	 * @var        string
	 */
	protected $p_cuenta;
	...
	/**
	 * Set the value of [seg_des] column.
	 * 
	 * @param      string $v new value
	 * @return     Segmento The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [c_cuenta] column.
	 * 
	 * @param      string $v new value
	 * @return     Segmento The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [p_cuenta] column.
	 * 
	 * @param      string $v new value
	 * @return     Segmento The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(SegmentoPeer::SEG_DES,SegmentoPeer::C_CUENTA,SegmentoPeer::P_CUENTA,SegmentoPeer::DIS_CEN,SegmentoPeer::CAMPO1,SegmentoPeer::CAMPO2,SegmentoPeer::CAMPO3,SegmentoPeer::CAMPO4,SegmentoPeer::CO_US_IN,SegmentoPeer::CO_US_MO,SegmentoPeer::CO_US_EL,SegmentoPeer::REVISADO,SegmentoPeer::TRASNFE,SegmentoPeer::CO_SUCU,SegmentoPeer::ROWGUID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_seg = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->seg_des = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->c_cuenta = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->p_cuenta = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->dis_cen = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 19; // 19 = SegmentoPeer::NUM_COLUMNS - SegmentoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Generic method to set the primary key (co_seg column).
	 *
	 ...
	 * related Clientess from storage. If this Segmento is new, it will return
		...
		if ($this->collClientess === null) {
			if ($this->isNew()) {
			   $this->collClientess = array();
				...
				$criteria->add(ClientesPeer::CO_SEG, $this->co_seg);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Segmento has previously been saved, it will retrieve
	 * related Provs from storage. If this Segmento is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProvs === null) {
			if ($this->isNew()) {
			   $this->collProvs = array();
				...
				$criteria->add(ProvPeer::CO_SEG, $this->co_seg);
