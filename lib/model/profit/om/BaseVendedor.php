  ...
  const PEER = 'VendedorPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->comision = ($row[$startcol + 10] !== null) ? (double) $row[$startcol + 10] : null;
			...
			$this->comisionv = ($row[$startcol + 14] !== null) ? (double) $row[$startcol + 14] : null;
			...
			$this->net_ult_ve = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
