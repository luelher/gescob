  ...
  const PEER = 'TabuladoPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->porc_vent = ($row[$startcol + 2] !== null) ? (double) $row[$startcol + 2] : null;
			$this->porc_comp = ($row[$startcol + 3] !== null) ? (double) $row[$startcol + 3] : null;
			$this->porc_cxs = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
			$this->porc_otro = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
