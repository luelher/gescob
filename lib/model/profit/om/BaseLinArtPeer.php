...
/**
 * Base static class for performing query and update operations on the 'lin_art' table.
 *
 * 
 *
...
abstract class BaseLinArtPeer {
	...
	const CLASS_DEFAULT = 'lib.model.profit.LinArt';
	...
	/** the column name for the LIN_DES field */
	...
	/** the column name for the COMI_LIN field */
	const COMI_LIN = 'lin_art.COMI_LIN';

	/** the column name for the COMI_LIN2 field */
	...
	/** the column name for the I_LIN_DES field */
	...
	/**
	 * An identiy map to hold any loaded instances of LinArt objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('coLin', 'linDes', 'disCen', 'campo1', 'campo2', 'campo3', 'campo4', 'coUsIn', 'feUsIn', 'coUsMo', 'feUsMo', 'coUsEl', 'feUsEl', 'revisado', 'trasnfe', 'coSucu', 'rowguid', 'coImun', 'coReten', 'comiLin', 'comiLin2', 'rowId', 'va', 'iLinDes', 'movil', ),
		BasePeer::TYPE_COLNAME => array (self::CO_LIN, self::LIN_DES, self::DIS_CEN, self::CAMPO1, self::CAMPO2, self::CAMPO3, self::CAMPO4, self::CO_US_IN, self::FE_US_IN, self::CO_US_MO, self::FE_US_MO, self::CO_US_EL, self::FE_US_EL, self::REVISADO, self::TRASNFE, self::CO_SUCU, self::ROWGUID, self::CO_IMUN, self::CO_RETEN, self::COMI_LIN, self::COMI_LIN2, self::ROW_ID, self::VA, self::I_LIN_DES, self::MOVIL, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('coLin' => 0, 'linDes' => 1, 'disCen' => 2, 'campo1' => 3, 'campo2' => 4, 'campo3' => 5, 'campo4' => 6, 'coUsIn' => 7, 'feUsIn' => 8, 'coUsMo' => 9, 'feUsMo' => 10, 'coUsEl' => 11, 'feUsEl' => 12, 'revisado' => 13, 'trasnfe' => 14, 'coSucu' => 15, 'rowguid' => 16, 'coImun' => 17, 'coReten' => 18, 'comiLin' => 19, 'comiLin2' => 20, 'rowId' => 21, 'va' => 22, 'iLinDes' => 23, 'movil' => 24, ),
		BasePeer::TYPE_COLNAME => array (self::CO_LIN => 0, self::LIN_DES => 1, self::DIS_CEN => 2, self::CAMPO1 => 3, self::CAMPO2 => 4, self::CAMPO3 => 5, self::CAMPO4 => 6, self::CO_US_IN => 7, self::FE_US_IN => 8, self::CO_US_MO => 9, self::FE_US_MO => 10, self::CO_US_EL => 11, self::FE_US_EL => 12, self::REVISADO => 13, self::TRASNFE => 14, self::CO_SUCU => 15, self::ROWGUID => 16, self::CO_IMUN => 17, self::CO_RETEN => 18, self::COMI_LIN => 19, self::COMI_LIN2 => 20, self::ROW_ID => 21, self::VA => 22, self::I_LIN_DES => 23, self::MOVIL => 24, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new LinArtMapBuilder();
		}
	 ...
	 * @param      string $column The column name for current table. (i.e. LinArtPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(LinArtPeer::TABLE_NAME);
    ...
    foreach (sfMixer::getCallables('BaseLinArtPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseLinArtPeer', $criteria, $con);
    }
	...
	{
		return LinArtPeer::populateObjects(LinArtPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseLinArtPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseLinArtPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      LinArt $value A LinArt object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(LinArt $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getCoLin();
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A LinArt object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof LinArt) {
				$key = (string) $value->getCoLin();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or LinArt object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     LinArt Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = LinArtPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = LinArtPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				LinArtPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a LinArt or Criteria object.
	 *
	 * @param      mixed $values Criteria or LinArt object containing data that is used to create the INSERT statement.
    ...
    foreach (sfMixer::getCallables('BaseLinArtPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLinArtPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from LinArt object
		}
    ...
    foreach (sfMixer::getCallables('BaseLinArtPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseLinArtPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a LinArt or Criteria object.
	 *
	 * @param      mixed $values Criteria or LinArt object containing data that is used to create the UPDATE statement.
    ...
    foreach (sfMixer::getCallables('BaseLinArtPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLinArtPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseLinArtPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseLinArtPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the lin_art table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a LinArt or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or LinArt object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			LinArtPeer::clearInstancePool();

			// rename for clarity
			$criteria = clone $values;
		} elseif ($values instanceof LinArt) {
			// invalidate the cache for this single object
			LinArtPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				LinArtPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given LinArt object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      LinArt $obj The object to validate.
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = LinArtPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the LinArtPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the LinArtPeer class:
//
// Propel::getDatabaseMap(LinArtPeer::DATABASE_NAME)->addTableBuilder(LinArtPeer::TABLE_NAME, LinArtPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseLinArtPeer::DATABASE_NAME)->addTableBuilder(BaseLinArtPeer::TABLE_NAME, BaseLinArtPeer::getMapBuilder());
