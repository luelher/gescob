  ...
  const PEER = 'RengFacPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->total_art = ($row[$startcol + 8] !== null) ? (double) $row[$startcol + 8] : null;
			$this->stotal_art = ($row[$startcol + 9] !== null) ? (double) $row[$startcol + 9] : null;
			$this->pendiente = ($row[$startcol + 10] !== null) ? (double) $row[$startcol + 10] : null;
			$this->uni_venta = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->prec_vta = ($row[$startcol + 12] !== null) ? (double) $row[$startcol + 12] : null;
			...
			$this->isv = ($row[$startcol + 15] !== null) ? (double) $row[$startcol + 15] : null;
			$this->reng_neto = ($row[$startcol + 16] !== null) ? (double) $row[$startcol + 16] : null;
			$this->cos_pro_un = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->ult_cos_un = ($row[$startcol + 18] !== null) ? (double) $row[$startcol + 18] : null;
			$this->ult_cos_om = ($row[$startcol + 19] !== null) ? (double) $row[$startcol + 19] : null;
			$this->cos_pro_om = ($row[$startcol + 20] !== null) ? (double) $row[$startcol + 20] : null;
			$this->total_dev = ($row[$startcol + 21] !== null) ? (double) $row[$startcol + 21] : null;
			$this->monto_dev = ($row[$startcol + 22] !== null) ? (double) $row[$startcol + 22] : null;
			$this->prec_vta2 = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
			...
			$this->cant_imp = ($row[$startcol + 27] !== null) ? (double) $row[$startcol + 27] : null;
			...
			$this->total_uni = ($row[$startcol + 30] !== null) ? (double) $row[$startcol + 30] : null;
			$this->mon_ilc = ($row[$startcol + 31] !== null) ? (double) $row[$startcol + 31] : null;
			$this->otros = ($row[$startcol + 32] !== null) ? (double) $row[$startcol + 32] : null;
			...
			$this->pendiente2 = ($row[$startcol + 35] !== null) ? (double) $row[$startcol + 35] : null;
			...
			$this->cant_prod = ($row[$startcol + 43] !== null) ? (double) $row[$startcol + 43] : null;
			$this->imp_prod = ($row[$startcol + 44] !== null) ? (double) $row[$startcol + 44] : null;
			$this->resetModified();
