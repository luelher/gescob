  ...
  const PEER = 'FacturaPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->saldo = ($row[$startcol + 9] !== null) ? (double) $row[$startcol + 9] : null;
			...
			$this->tot_bruto = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->tot_neto = ($row[$startcol + 18] !== null) ? (double) $row[$startcol + 18] : null;
			$this->glob_desc = ($row[$startcol + 19] !== null) ? (double) $row[$startcol + 19] : null;
			$this->tot_reca = ($row[$startcol + 20] !== null) ? (double) $row[$startcol + 20] : null;
			...
			$this->total_uc = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
			$this->total_cp = ($row[$startcol + 24] !== null) ? (double) $row[$startcol + 24] : null;
			$this->tot_flete = ($row[$startcol + 25] !== null) ? (double) $row[$startcol + 25] : null;
			$this->monto_dev = ($row[$startcol + 26] !== null) ? (double) $row[$startcol + 26] : null;
			$this->totklu = ($row[$startcol + 27] !== null) ? (double) $row[$startcol + 27] : null;
			...
			$this->iva = ($row[$startcol + 30] !== null) ? (double) $row[$startcol + 30] : null;
			$this->iva_dev = ($row[$startcol + 31] !== null) ? (double) $row[$startcol + 31] : null;
			$this->numcom = ($row[$startcol + 32] !== null) ? (int) $row[$startcol + 32] : null;
			$this->tasa = ($row[$startcol + 33] !== null) ? (double) $row[$startcol + 33] : null;
			$this->dis_cen = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
			$this->vuelto = ($row[$startcol + 35] !== null) ? (double) $row[$startcol + 35] : null;
			$this->seriales = ($row[$startcol + 36] !== null) ? (int) $row[$startcol + 36] : null;
			$this->tasag = ($row[$startcol + 37] !== null) ? (double) $row[$startcol + 37] : null;
			$this->tasag10 = ($row[$startcol + 38] !== null) ? (double) $row[$startcol + 38] : null;
			$this->tasag20 = ($row[$startcol + 39] !== null) ? (double) $row[$startcol + 39] : null;
