  ...
  const PEER = 'ClientesPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->net_ult_ve = ($row[$startcol + 16] !== null) ? (double) $row[$startcol + 16] : null;
			$this->mont_cre = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->plaz_pag = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->desc_ppago = ($row[$startcol + 19] !== null) ? (double) $row[$startcol + 19] : null;
			...
			$this->desc_glob = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
			...
			$this->iva = ($row[$startcol + 35] !== null) ? (double) $row[$startcol + 35] : null;
