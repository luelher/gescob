...
/**
 * Base class that represents a row from the 'proceden' table.
 *
 * 
 *
...
abstract class BaseProceden extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProcedenPeer';
	...
	/**
	 * The value for the cod_proc field.
	 * @var        string
	 */
	protected $cod_proc;

	/**
	 * The value for the des_proc field.
	...
	/**
	 * Initializes internal state of BaseProceden object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Set the value of [cod_proc] column.
	 * 
	 * @param      string $v new value
	 * @return     Proceden The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [des_proc] column.
	 * 
	 * @param      string $v new value
	 * @return     Proceden The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ProcedenPeer::DES_PROC,ProcedenPeer::CAMPO1,ProcedenPeer::CAMPO2,ProcedenPeer::CAMPO3,ProcedenPeer::CAMPO4,ProcedenPeer::CO_US_IN,ProcedenPeer::CO_US_MO,ProcedenPeer::CO_US_EL,ProcedenPeer::REVISADO,ProcedenPeer::TRASNFE,ProcedenPeer::CO_SUCU,ProcedenPeer::ROWGUID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cod_proc = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->des_proc = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 16; // 16 = ProcedenPeer::NUM_COLUMNS - ProcedenPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProcedenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseProceden:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseProceden:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseProceden:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseProceden:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ProcedenPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	/**
	 * Generic method to set the primary key (cod_proc column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Proceden (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCodProc($this->cod_proc);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Proceden Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Proceden has previously been saved, it will retrieve
	 * related Arts from storage. If this Proceden is new, it will return
		...
		if ($this->collArts === null) {
			if ($this->isNew()) {
			   $this->collArts = array();
				...
				$criteria->add(ArtPeer::PROCEDENCI, $this->cod_proc);
	 ...
	 * Otherwise if this Proceden is new, it will return
	 * an empty collection; or if this Proceden has previously
	 * been saved, it will retrieve related Arts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Proceden.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseProceden:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseProceden::%s', $method));
    }
