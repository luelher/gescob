  ...
  const PEER = 'ProvPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->net_ult_co = ($row[$startcol + 15] !== null) ? (double) $row[$startcol + 15] : null;
			$this->saldo = ($row[$startcol + 16] !== null) ? (double) $row[$startcol + 16] : null;
			$this->saldo_ini = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->mont_cre = ($row[$startcol + 18] !== null) ? (double) $row[$startcol + 18] : null;
			$this->plaz_pag = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->desc_ppago = ($row[$startcol + 20] !== null) ? (double) $row[$startcol + 20] : null;
			$this->desc_glob = ($row[$startcol + 21] !== null) ? (double) $row[$startcol + 21] : null;
			$this->tipo_iva = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->iva = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
