  ...
  const PEER = 'ArtPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->uni_relac = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->relac_aut = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->stock_act = ($row[$startcol + 19] !== null) ? (double) $row[$startcol + 19] : null;
			$this->stock_com = ($row[$startcol + 20] !== null) ? (double) $row[$startcol + 20] : null;
			$this->sstock_com = ($row[$startcol + 21] !== null) ? (double) $row[$startcol + 21] : null;
			$this->stock_lle = ($row[$startcol + 22] !== null) ? (double) $row[$startcol + 22] : null;
			$this->sstock_lle = ($row[$startcol + 23] !== null) ? (double) $row[$startcol + 23] : null;
			$this->stock_des = ($row[$startcol + 24] !== null) ? (double) $row[$startcol + 24] : null;
			$this->sstock_des = ($row[$startcol + 25] !== null) ? (double) $row[$startcol + 25] : null;
			...
			$this->suni_relac = ($row[$startcol + 28] !== null) ? (double) $row[$startcol + 28] : null;
			$this->sstock_act = ($row[$startcol + 29] !== null) ? (double) $row[$startcol + 29] : null;
			$this->relac_comp = ($row[$startcol + 30] !== null) ? (double) $row[$startcol + 30] : null;
			$this->relac_vent = ($row[$startcol + 31] !== null) ? (double) $row[$startcol + 31] : null;
			$this->pto_pedido = ($row[$startcol + 32] !== null) ? (double) $row[$startcol + 32] : null;
			$this->stock_max = ($row[$startcol + 33] !== null) ? (double) $row[$startcol + 33] : null;
			$this->stock_min = ($row[$startcol + 34] !== null) ? (double) $row[$startcol + 34] : null;
			$this->prec_om = ($row[$startcol + 35] !== null) ? (boolean) $row[$startcol + 35] : null;
			$this->prec_vta1 = ($row[$startcol + 36] !== null) ? (double) $row[$startcol + 36] : null;
			...
			$this->prec_vta2 = ($row[$startcol + 39] !== null) ? (double) $row[$startcol + 39] : null;
			$this->fec_prec_3 = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
			$this->prec_vta3 = ($row[$startcol + 41] !== null) ? (double) $row[$startcol + 41] : null;
			$this->fec_prec_4 = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
			$this->prec_vta4 = ($row[$startcol + 43] !== null) ? (double) $row[$startcol + 43] : null;
			$this->fec_prec_5 = ($row[$startcol + 44] !== null) ? (string) $row[$startcol + 44] : null;
			$this->prec_vta5 = ($row[$startcol + 45] !== null) ? (double) $row[$startcol + 45] : null;
			$this->prec_agr1 = ($row[$startcol + 46] !== null) ? (double) $row[$startcol + 46] : null;
			$this->prec_agr2 = ($row[$startcol + 47] !== null) ? (double) $row[$startcol + 47] : null;
			$this->prec_agr3 = ($row[$startcol + 48] !== null) ? (double) $row[$startcol + 48] : null;
			$this->prec_agr4 = ($row[$startcol + 49] !== null) ? (double) $row[$startcol + 49] : null;
			$this->prec_agr5 = ($row[$startcol + 50] !== null) ? (double) $row[$startcol + 50] : null;
			$this->can_agr = ($row[$startcol + 51] !== null) ? (double) $row[$startcol + 51] : null;
			...
			$this->margen_max = ($row[$startcol + 55] !== null) ? (double) $row[$startcol + 55] : null;
			$this->ult_cos_un = ($row[$startcol + 56] !== null) ? (double) $row[$startcol + 56] : null;
			$this->fec_ult_co = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
			$this->cos_pro_un = ($row[$startcol + 58] !== null) ? (double) $row[$startcol + 58] : null;
			$this->fec_cos_pr = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
			$this->cos_merc = ($row[$startcol + 60] !== null) ? (double) $row[$startcol + 60] : null;
			$this->fec_cos_me = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
			$this->cos_prov = ($row[$startcol + 62] !== null) ? (double) $row[$startcol + 62] : null;
			$this->fec_cos_p2 = ($row[$startcol + 63] !== null) ? (string) $row[$startcol + 63] : null;
			$this->ult_cos_do = ($row[$startcol + 64] !== null) ? (double) $row[$startcol + 64] : null;
			$this->fec_cos_do = ($row[$startcol + 65] !== null) ? (string) $row[$startcol + 65] : null;
			$this->cos_un_an = ($row[$startcol + 66] !== null) ? (double) $row[$startcol + 66] : null;
			$this->fec_cos_an = ($row[$startcol + 67] !== null) ? (string) $row[$startcol + 67] : null;
			$this->ult_cos_om = ($row[$startcol + 68] !== null) ? (double) $row[$startcol + 68] : null;
			$this->fec_ult_om = ($row[$startcol + 69] !== null) ? (string) $row[$startcol + 69] : null;
			$this->cos_pro_om = ($row[$startcol + 70] !== null) ? (double) $row[$startcol + 70] : null;
			...
			$this->mont_comi = ($row[$startcol + 73] !== null) ? (double) $row[$startcol + 73] : null;
			$this->porc_cos = ($row[$startcol + 74] !== null) ? (double) $row[$startcol + 74] : null;
			$this->mont_cos = ($row[$startcol + 75] !== null) ? (double) $row[$startcol + 75] : null;
			$this->porc_gas = ($row[$startcol + 76] !== null) ? (double) $row[$startcol + 76] : null;
			$this->mont_gas = ($row[$startcol + 77] !== null) ? (double) $row[$startcol + 77] : null;
			...
			$this->punt_cli = ($row[$startcol + 80] !== null) ? (double) $row[$startcol + 80] : null;
			$this->punt_pro = ($row[$startcol + 81] !== null) ? (double) $row[$startcol + 81] : null;
			...
			$this->mon_ilc = ($row[$startcol + 88] !== null) ? (double) $row[$startcol + 88] : null;
			$this->capacidad = ($row[$startcol + 89] !== null) ? (double) $row[$startcol + 89] : null;
			$this->grado_al = ($row[$startcol + 90] !== null) ? (double) $row[$startcol + 90] : null;
			...
			$this->equi_uni1 = ($row[$startcol + 113] !== null) ? (double) $row[$startcol + 113] : null;
			$this->equi_uni2 = ($row[$startcol + 114] !== null) ? (double) $row[$startcol + 114] : null;
			$this->equi_uni3 = ($row[$startcol + 115] !== null) ? (double) $row[$startcol + 115] : null;
			...
			$this->peso = ($row[$startcol + 132] !== null) ? (double) $row[$startcol + 132] : null;
			$this->pie = ($row[$startcol + 133] !== null) ? (double) $row[$startcol + 133] : null;
			$this->margen1 = ($row[$startcol + 134] !== null) ? (double) $row[$startcol + 134] : null;
			$this->margen2 = ($row[$startcol + 135] !== null) ? (double) $row[$startcol + 135] : null;
			$this->margen3 = ($row[$startcol + 136] !== null) ? (double) $row[$startcol + 136] : null;
			$this->margen4 = ($row[$startcol + 137] !== null) ? (double) $row[$startcol + 137] : null;
			$this->margen5 = ($row[$startcol + 138] !== null) ? (double) $row[$startcol + 138] : null;
			...
			$this->rel_emp = ($row[$startcol + 144] !== null) ? (double) $row[$startcol + 144] : null;
