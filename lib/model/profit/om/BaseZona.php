...
abstract class BaseZona extends BaseObject  implements Persistent {
  ...
  const PEER = 'ZonaPeer';
	...
	/**
	 * The value for the zon_des field.
	...
	/**
	 * Initializes internal state of BaseZona object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Set the value of [zon_des] column.
	 * 
	 * @param      string $v new value
	 * @return     Zona The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ZonaPeer::ZON_DES,ZonaPeer::DIS_CEN,ZonaPeer::CAMPO1,ZonaPeer::CAMPO2,ZonaPeer::CAMPO3,ZonaPeer::CAMPO4,ZonaPeer::CO_US_IN,ZonaPeer::CO_US_MO,ZonaPeer::CO_US_EL,ZonaPeer::REVISADO,ZonaPeer::TRASNFE,ZonaPeer::CO_SUCU,ZonaPeer::ROWGUID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_zon = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->zon_des = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 17; // 17 = ZonaPeer::NUM_COLUMNS - ZonaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Generic method to set the primary key (co_zon column).
	 *
	 ...
	 * related Clientess from storage. If this Zona is new, it will return
		...
		if ($this->collClientess === null) {
			if ($this->isNew()) {
			   $this->collClientess = array();
				...
				$criteria->add(ClientesPeer::CO_ZON, $this->co_zon);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Zona has previously been saved, it will retrieve
	 * related Provs from storage. If this Zona is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProvs === null) {
			if ($this->isNew()) {
			   $this->collProvs = array();
				...
				$criteria->add(ProvPeer::CO_ZON, $this->co_zon);
