 ...
 */
class BaseSubAlmaFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'des_sub'    => new sfWidgetFormFilterInput(),
      'co_alma'    => new sfWidgetFormPropelChoice(array('model' => 'Almacen', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'co_alma'    => new sfValidatorPropelChoice(array('required' => false, 'model' => 'Almacen', 'column' => 'co_alma')),
