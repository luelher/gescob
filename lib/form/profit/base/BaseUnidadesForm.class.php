 ...
 */
class BaseUnidadesForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'co_uni'   => new sfWidgetFormInputHidden(),
      'des_uni'  => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      'co_uni'   => new sfValidatorPropelChoice(array('model' => 'Unidades', 'column' => 'co_uni', 'required' => false)),
      'des_uni'  => new sfValidatorString(array('max_length' => 60)),
